...
- 588a94e: Default Node/Linux rendering to Vulkan even when X11 or Wayland is available, avoiding Dawn's known restricted-mip-view/storage-write defect in OpenGL. The existing compatibility feature level is unchanged. macOS, Windows and browser backend defaults are unchanged.
