...
summary: Run a generated compute function with application-owned Metal buffers, a pipeline, and an explicit workgroup grid.
websitePath: /native/macos/metal/compute/dispatch
keywords: native, macos, metal, swift, compute, storage, runtime array, workgroup size
---

# Dispatch WGSL compute
