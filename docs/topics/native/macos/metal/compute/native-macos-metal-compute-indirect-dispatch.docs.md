...
summary: Use generated functions and prepared binding data in an application-owned Metal indirect command buffer.
websitePath: /native/macos/metal/compute/indirect-dispatch
keywords: native, macos, metal, swift, compute, indirect command buffer, prepared bindings
---

# Encode native indirect dispatch
