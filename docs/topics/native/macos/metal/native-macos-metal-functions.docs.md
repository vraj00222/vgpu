...
summary: Load generated shader programs on your Metal device and use their functions in native pipelines.
websitePath: /native/macos/metal/functions
keywords: native, macos, metal, swift, metallib, generated package, shader functions, load
---
