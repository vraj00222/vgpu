...
summary: Select WGSL entry points and an owned output directory for a generated Swift package.
websitePath: /native/macos/metal/tooling/configuration
keywords: native, macos, metal, swift, configuration, build, package, entry points
---

# Configure a Metal package
